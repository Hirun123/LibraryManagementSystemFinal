...
//    }
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Publisher Name", "Address", "Email"
            }
        ) {
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
      ...
      String name = txtname.getText();
        ...
        try {
            ...
            pst = dbc.getCon().prepareStatement("INSERT INTO publisher(name,address,email) VALUES(?,?,?)");
    ...
    private void txtupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtupdateActionPerformed
        ...
        try {
            ...
            pst = dbc.getCon().prepareStatement("UPDATE publisher SET name=?,address=?,email=? WHERE id=?");
            pst.setString(1, name);
            pst.setString(2, address);
            pst.setString(3, email);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            pst = dbc.getCon().prepareStatement("DELETE FROM publisher WHERE id=?");
    ...
    public final void DisplayTable() {
        ...
        try {
            dbc.Open();
            pst = dbc.getCon().prepareStatement("SELECT * FROM publisher Order BY id DESC");
